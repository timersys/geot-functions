...
class GeotNotices {
	...
	public function __construct( ) {
        ...
        if( ! get_option('spu_wpengine_dismiss') )
	...
	public static function wpengine(){
		...
		<p>Please go to the <a href="<?php echo admin_url('admin.php?page=geot-settings');?>">settings page</a> and enable it for using it with GeotargetingWP plugins.</p>
