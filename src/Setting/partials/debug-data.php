...
Server:                   <?php
echo '$_SERVER[REMOTE_ADDR]            = '; echo isset( $_SERVER['REMOTE_ADDR'] ) ? $_SERVER['REMOTE_ADDR'] : 'not resolved';?><?php echo PHP_EOL; ?>
Cloudflare:               <?php
...
if( getenv('HTTP_GEOIP_COUNTRY_CODE')){
	echo "getenv( 'HTTP_GEOIP_CITY' )         :"; echo getenv( 'HTTP_GEOIP_CITY' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_POSTAL_CODE' )  :"; echo getenv( 'HTTP_GEOIP_POSTAL_CODE' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_COUNTRY_CODE' ) :"; echo getenv( 'HTTP_GEOIP_COUNTRY_CODE' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_COUNTRY_NAME' ) :"; echo getenv( 'HTTP_GEOIP_COUNTRY_NAME' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_AREA_CODE' )    :"; echo getenv( 'HTTP_GEOIP_AREA_CODE' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_REGION' )       :"; echo getenv( 'HTTP_GEOIP_REGION' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_LATITUDE' )     :"; echo getenv( 'HTTP_GEOIP_LATITUDE' ) . PHP_EOL ;
	echo "getenv( 'HTTP_GEOIP_LONGITUDE' )    :"; echo getenv( 'HTTP_GEOIP_LONGITUDE' ) . PHP_EOL ;
}
?>
kinsta:                   <?php
...
if( !empty( $_SERVER['HTTP_GEOIP_CITY_COUNTRY_NAME'] ) ) {
	echo '$_SERVER[ "HTTP_GEOIP_CITY_CONTINENT_CODE" ] :'; echo $_SERVER['HTTP_GEOIP_CITY_CONTINENT_CODE'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_CITY" ]                :'; echo $_SERVER['HTTP_GEOIP_CITY'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_POSTAL_CODE" ]         :'; echo $_SERVER['HTTP_GEOIP_POSTAL_CODE'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_CITY_COUNTRY_CODE" ]   :'; echo $_SERVER['HTTP_GEOIP_CITY_COUNTRY_CODE'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_CITY_COUNTRY_NAME" ]   :'; echo $_SERVER['HTTP_GEOIP_CITY_COUNTRY_NAME'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_REGION" ]              :'; echo $_SERVER['HTTP_GEOIP_REGION'] . PHP_EOL ;
	echo '$_SERVER[ "HTTP_GEOIP_LATITUDE" ]            :'; echo $_SERVER['HTTP_GEOIP_LATITUDE'] . PHP_EOL ;
...
Cache mode:               <?php echo isset($opts['debug_mode']) && $opts['debug_mode'] ? 'On' : 'Off'; ?><?php echo PHP_EOL; ?>
Debug mode:               <?php echo isset($opts['cache_mode']) && $opts['cache_mode'] ? 'On' : 'Off'; ?><?php echo PHP_EOL; ?>
